    ...
    <body>
        ...
        <div class="row ">   
            <div class="col-md-4 ">
                ...
                <div class="col-sm- bg-darkt card-body">
                    <hr>
                    <hr>
                    <h5 class="text-primary elegant-font"><b>Formulario Registro</b></h5> 
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" value="${User.getNombreProductos()}"  id="nombreProductos" 
                                           name="nombreProductos" placeholder="Ingrese Nombre">
                                </div>                           

                                <div class="form-group text-left">
                                    <label for="plu"class="text-left">Plu</label>
                                    <input type="text" class="form-control"  value="${User.getPlu()}" id="plu"
                                           name="plu" placeholder="Ingrese Plu">
                                </div>

                                <div class="form-group text-left">
                                    <label for="cantidad"class="text-left">Cantidad</label>
                                    <input type="text" class="form-control"  value="${User.getCantidad()}" id="cantidad"
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <select class="form-control" id="tipos" value="${User.getCategorias_idCategorias()}" name="categorias_idCategorias">
                ...
                <div class="form-group mt-3 text-center" style="border: none;">
                    ...
                    <button type="submit" name="accion" value="editarProductos" class="btn btn-success">
        ...
        <style>
            ...
            body {
                ...
                background-image: url('img/jio.jpg');
